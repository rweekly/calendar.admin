...
send_decline_message <- function(
  ...
  msg <- glue::glue("
    Greetings, @channel! Curator {curator_name} ({curator_id}) is not able to curate the R Weekly issue {issue_id} covering the date range {curation_start} to {curation_end}.
