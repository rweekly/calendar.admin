create_curator_df <- function() {
  curator_df <- tibble::tribble(
    ...
    "Batool Almazrouq", "@BatoolMM", "khaki", "batool@liverpool.ac.uk", "https://github.com/BatoolMM.png",
    ...
    "Jonathan Kitt", "@Jonathan Kitt", "greenyellow", "jonathan.kitt@proton.me", "https://github.com/KittJonathan.png",
